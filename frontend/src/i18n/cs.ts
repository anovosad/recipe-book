...
export const cs: Dictionary = {
  ...
  // Recipe form
  'users.title': 'Účty',
  'users.intro': 'Registrace je zavřená, účty se rozdávají tady. Každý, kdo účet má, může upravit i smazat kterýkoli recept.',
  'users.addTitle': 'Přidat účet',
  'users.listTitle': 'Všichni, kdo mají účet',
  'users.username': 'Uživatelské jméno',
  'users.email': 'E-mail',
  'users.password': 'Heslo',
  'users.passwordHelp': 'Aspoň 6 znaků, písmeno a číslice. Je vidět při psaní — předejte ho, po přihlášení si ho může změnit.',
  'users.makeAdmin': 'Může spravovat účty',
  'users.create': 'Vytvořit účet',
  'users.creating': 'Vytvářím…',
  'users.created': 'Účet pro {username} vytvořen',
  'users.admin': 'Spravuje účty',
  'users.grantAdmin': 'Povolit správu účtů',
  'users.revokeAdmin': 'Odebrat správu účtů',
  'users.you': '(vy)',
  'users.cannotDeleteSelf': 'Účet, kterým jste přihlášeni, smazat nelze',
  'users.deleteConfirm': 'Smazat účet {username}? Jeho recepty zůstanou ve sbírce a připíšou se vám.',
  'users.deleted': 'Účet {username} smazán, recepty zůstaly',
  'users.loadFailed': 'Účty se nepodařilo načíst',
  'nav.users': 'Účty',
  ...
  'form.moveIngredientUp': 'Posunout nahoru',
  'form.moveIngredientDown': 'Posunout dolů',
  'form.ingredientOrderHint': 'Pořadí tady je pořadí, ve kterém se suroviny v receptu zobrazí.',
