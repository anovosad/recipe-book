	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if recipe != nil && len(recipe.Images) > 0 {
			...
			for _, img := range recipe.Images {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/recipe-form.templ`, Line: 72, Col: 66}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/recipe-form.templ`, Line: 73, Col: 44}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/recipe-form.templ`, Line: 73, Col: 64}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/recipe-form.templ`, Line: 75, Col: 46}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/recipe-form.templ`, Line: 76, Col: 109}
				}
...
func RecipeBasicInfoSection(recipe *models.Recipe) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var11, templ_7745c5c3_Err = templ.JoinStringErrs(ternary(recipe != nil, recipe.Title, ""))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/recipe-form.templ`, Line: 103, Col: 55}
		}
		...
		templ_7745c5c3_Var12, templ_7745c5c3_Err = templ.JoinStringErrs(ternary(recipe != nil, recipe.Description, ""))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/recipe-form.templ`, Line: 108, Col: 102}
		}
...
func RecipeDetailsSection(recipe *models.Recipe) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var14, templ_7745c5c3_Err = templ.JoinStringErrs(ternary(recipe != nil, strconv.Itoa(recipe.PrepTime), ""))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/recipe-form.templ`, Line: 120, Col: 74}
		}
		...
		templ_7745c5c3_Var15, templ_7745c5c3_Err = templ.JoinStringErrs(ternary(recipe != nil, strconv.Itoa(recipe.CookTime), ""))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/recipe-form.templ`, Line: 125, Col: 74}
		}
		...
		templ_7745c5c3_Var16, templ_7745c5c3_Err = templ.JoinStringErrs(ternary(recipe != nil, strconv.Itoa(recipe.Servings), ""))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/recipe-form.templ`, Line: 130, Col: 74}
		}
		...
		templ_7745c5c3_Var17, templ_7745c5c3_Err = templ.JoinStringErrs(ternary(recipe != nil, recipe.ServingUnit, "people"))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/recipe-form.templ`, Line: 134, Col: 137}
		}
		...
		templ_7745c5c3_Err = ServingUnitOptions(ternary(recipe != nil, recipe.ServingUnit, "people")).Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
func ServingUnitOptions(currentUnit string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, unit := range models.ServingUnits {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/recipe-form.templ`, Line: 144, Col: 28}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/recipe-form.templ`, Line: 144, Col: 83}
			}
...
func ExistingIngredientRow(ingredient models.RecipeIngredient, allIngredients []models.Ingredient) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/recipe-form.templ`, Line: 171, Col: 100}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/recipe-form.templ`, Line: 172, Col: 98}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/recipe-form.templ`, Line: 173, Col: 69}
		}
		...
		for _, ing := range allIngredients {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/recipe-form.templ`, Line: 177, Col: 40}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/recipe-form.templ`, Line: 177, Col: 101}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/recipe-form.templ`, Line: 181, Col: 96}
		}
...
func RecipeInstructionsSection(recipe *models.Recipe) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var33, templ_7745c5c3_Err = templ.JoinStringErrs(ternary(recipe != nil, recipe.Instructions, ""))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/recipe-form.templ`, Line: 255, Col: 114}
		}
...
func IngredientModal() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 91, "<div id=\"ingredient-modal\" class=\"modal hidden\"><div class=\"modal-content\"><div class=\"modal-header\"><h3><i class=\"fas fa-plus-circle\"></i> Add New Ingredient</h3><button type=\"button\" class=\"modal-close\" onclick=\"closeIngredientModal()\"><i class=\"fas fa-times\"></i></button></div><div class=\"modal-body\"><form id=\"new-ingredient-form\"><div class=\"form-group\"><label for=\"new-ingredient-name\">Ingredient Name *</label> <input type=\"text\" id=\"new-ingredient-name\" class=\"form-control\" placeholder=\"e.g., Olive Oil, Chicken Breast, etc.\" required></div><div class=\"modal-actions\"><button type=\"button\" class=\"btn btn-secondary\" onclick=\"closeIngredientModal()\"><i class=\"fas fa-times\"></i> Cancel</button> <button type=\"submit\" class=\"btn btn-primary\"><i class=\"fas fa-save\"></i> Add Ingredient</button></div></form></div></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func TagModal() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 92, "<div id=\"tag-modal\" class=\"modal hidden\"><div class=\"modal-content\"><div class=\"modal-header\"><h3><i class=\"fas fa-tag\"></i> Add New Tag</h3><button type=\"button\" class=\"modal-close\" onclick=\"closeTagModal()\"><i class=\"fas fa-times\"></i></button></div><div class=\"modal-body\"><form id=\"new-tag-form\"><div class=\"form-group\"><label for=\"new-tag-name\">Tag Name *</label> <input type=\"text\" id=\"new-tag-name\" class=\"form-control\" placeholder=\"e.g., Dessert, Quick &amp; Easy, etc.\" required></div><div class=\"form-group\"><label for=\"new-tag-color\">Tag Color</label> <input type=\"color\" id=\"new-tag-color\" class=\"form-control\" value=\"#ff6b6b\"></div><div class=\"modal-actions\"><button type=\"button\" class=\"btn btn-secondary\" onclick=\"closeTagModal()\"><i class=\"fas fa-times\"></i> Cancel</button> <button type=\"submit\" class=\"btn btn-primary\"><i class=\"fas fa-save\"></i> Add Tag</button></div></form></div></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
