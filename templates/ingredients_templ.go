...
// templates/ingredients.templ - Updated to use core.js functions
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if len(data.Ingredients) > 0 {
				...
				for _, ingredient := range data.Ingredients {
					...
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "\" class=\"ingredient-name\" title=\"")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/ingredients.templ`, Line: 24, Col: 138}
					}
...
func IngredientFormModal() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 21, "<div id=\"ingredient-form-modal\" class=\"modal hidden\"><div class=\"modal-content\"><div class=\"modal-header\"><h3><i class=\"fas fa-plus-circle\"></i> New Ingredient</h3><button type=\"button\" class=\"modal-close\"><i class=\"fas fa-times\"></i></button></div><div class=\"modal-body\"><form id=\"ingredientFormModal\" class=\"ingredient-form\"><div class=\"form-group\"><label for=\"ingredient-name\">Ingredient Name *</label> <input type=\"text\" id=\"ingredient-name\" name=\"name\" class=\"form-control\" required></div><div class=\"modal-actions\"><button type=\"button\" class=\"btn btn-secondary modal-close\"><i class=\"fas fa-times\"></i> Cancel</button> <button type=\"submit\" class=\"btn btn-primary\"><i class=\"fas fa-save\"></i> Save Ingredient</button></div></form></div></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
